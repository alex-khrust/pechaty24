        ...
        <table style="text-align:left; width:680px; margin:0 auto; font-size:14px; border-spacing:0px">
            ...
            <tr>
                <td bgcolor="#fff" style="padding: 15px;">
                    ...
                    <p>Здравствуйте <b>%email.nameuser%</b>, ваш заказ получен, в ближайшее время с вами свяжется оператор..</p>
                    <p>На данное письмо отвечать не нужно, оно автоматическое</p>p>
                    <hr>
